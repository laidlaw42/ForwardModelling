# TASK 3.2
# Change the radius of the second pluton.
# Make R_2 = 500, and then 2000 with X_2 = Y_2 = 6000 and t_end = 50,000. Describe the changes.
...
def task3part2(R_2):
    ...
    t_end = 50000 * 365.25 * 24 * 3600  # time end of simulation
    ...
    plt.title(label='Temperature field when second pluton intrudes, R_2 = ' + str(R_2))
    ...
    cax = fig.add_axes([0.85, 0.13, 0.02, 0.75])
    fig.colorbar(im, cax=cax)
    plt.title(label='Temperature field at the end of simulation, R_2 = ' + str(R_2))
    plt.show()
