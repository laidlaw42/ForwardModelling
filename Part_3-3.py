# TASK 3.3
#Change the temperature of the host rock to T_0 = 500. Describe the changes.
...
plt.title(label='Temperature field when second pluton intrudes, R_2 = ' + str(T_0))
...
ax.set_aspect('equal')
cax = fig.add_axes([0.85, 0.13, 0.02, 0.75])
plt.title(label='Temperature field at the end of simulation, T_0 = ' + str(T_0))
fig.colorbar(im, cax=cax)
plt.show()