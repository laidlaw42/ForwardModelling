# TASK 2.3
# Run the simulation to year 100 with hotter host rock.
# How does that change the temperature evolution of the central point or the temperature profile?
...
print('-----------------------------------------------------------------------------------------------------------')
print('This simulation will run at 100 years.')
print('What temperature do you want the host rock?')
print('Default temperature is 200⁰C')
print('Please enter a value: ')
hostRockTemperature = int(input())
T0 = hostRockTemperature  # temperature host rock <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
...
print('Peak temperature of the profile: ' + str(ymax) + '⁰C')
